...
class ngsimDataset(Dataset):
    ...
    def __getitem__(self, idx): # idx 某辆车某一时刻
       ...
       #  self.D[idx,7]=1.0或者2.0, 默认是float所以要int()，np.eye默认是float所以astype(int)
        ...
        return egoRelativeTrajHist,egoRelativeTrajFut,egoLatEnc,egoLonEnc #[31,2] [50,2] [2,2] [3,3] 维度不统一，没法用默认dataloader的collate_fn
    ...
    def collate_fn(self,samples):
        ...
        这里egoRelativeTrajHist,egoRelativeTrajFut,egoLatEnc,egoLonEnc #[31,2] [50,2] [2,2] [3,3] 维度不统一，没法用默认dataloader的collate_fn
        '''
        ...
        egoRelativeTrajFut_batch=torch.zeros(self.t_f,len(samples),2)
        ...
        return egoRelativeTrajHist_batch,egoRelativeTrajFut_batch,egoLatEnc_batch,egoLonEnc_batch,output_batch